    ...
    >
      ...
      <div className="flex md:flex-row lg:flex-row flex-col items-center justify-center lg:gap-20 gap-8 w-[100vw] md:w-[85vw] lg:w-[85vw] xl:w-[85vw] relative z-10">
        <div className="grid xl:grid-cols-4 lg:grid-cols-4 md:grid-cols-3 grid-cols-3 lg:w-auto xl:w-auto md:w-auto w-screen justify-center place-content-center py-6 gap-4">
          <motion.div initial={{opacity:0,y:-30}} whileInView={{opacity:1,y:0,transition:{duration:1,delay:1}}} className="animate flex mx-auto flex-col mt-4 text-[1.4vh] font-semibold justify-center items-center py-2 px-6 h-[82px] w-[82px] md:h-[87px] md:w-[87px] lg:h-[87px] lg:w-[87px] xl:h-[87px] xl:w-[87px] rounded-full bg-[#d4e3ea6d] hover:scale-105 hover:shadow-2xl transition-all duration-300">
            <img src={react} alt="react" />
            <div>ReactJs</div>
          </motion.div>
          <motion.div initial={{opacity:0,y:-30}} whileInView={{opacity:1,y:0,transition:{duration:1,delay:1}}} className="animate flex mx-auto  flex-col mt-4 text-[1.4vh] font-semibold justify-center items-center py-2 px-6 h-[87px] w-[87px] rounded-full bg-[#d4e3ea6d] hover:scale-105 hover:shadow-2xl transition-all duration-300">
          ...
          <motion.div initial={{opacity:0,y:-30}} whileInView={{opacity:1,y:0,transition:{duration:1,delay:1}}} className="animate flex mx-auto  flex-col mt-4 text-[1.4vh] font-semibold justify-center items-center py-2 px-6 h-[5.5rem] w-[5.5rem] rounded-full bg-[#d4e3ea6d] hover:scale-105 hover:shadow-2xl transition-all duration-300">
